  ...
  <div id="principal">   
    <div class="container text-red">
        ...
        @endif
         ...
         </br></br><h1>Editar Fragrancia</h1>
          <form action="/fragrancias/{{$fragrancia->id}}" method="post"enctype="multipart/form-data">
           @csrf
           @method('PUT')
           ...
           <div class="row">
              <div class="col">
                ...
                <input type="text" name="nome" id="nome" class="form-control formPlaceholder" placeholder="Digite o Nome da fragrancia" value="{{ $fragrancia->nome }}">
              </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="estoque" id ="estoque" class = "form-control formPlaceholder" placeholder="0" value="{{ $fragrancia->estoque }}" > <div class="col">ml</div> 
                </div>
                <div class="col">
                    <label for="totalUtilizado">Total Utilizado:</label>
                    <input type="text" name="totalUtilizado" id="totalUtilizado" class="form-control formPlaceholder" placeholder="0" value="{{ $fragrancia->totalUtilizado }}"> <div class="col">ml</div> 
                </div>
        ...
        <a href="/fragrancias" class="btn btn-light mt-5">Voltar</a>
