...
<body>
  ...
  <div id="principal">   
    <div class="container text-red">
           ...
           <div class="row">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="percentAgua" id ="percentAgua" class = "form-control formPlaceholder" placeholder="0" value="{{ $perfume->percentAgua }}" > <div class="col">ml</div> 
                </div>
                <div class="col">
                    <label for="percentAlcool">Percentual de Alcool:</label>
                    <input type="text" name="percentAlcool" id="percentAlcool" class="form-control formPlaceholder" placeholder="0" value="{{ $perfume->percentAlcool }}"> <div class="col">ml</div> 
                </div>
                <div class="col">
        ...
        <a href="/perfumes" class="btn btn-light mt-5">Voltar</a>
