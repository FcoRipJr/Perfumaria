  ...
  <div id="principal">   
    <div class="container text-red">
        ...
        @endif
          ...
          <form action="/fragancias" method="post" enctype="multipart/form-data">
           @csrf
            <div class="row">
              <div class="col">
                <label for="nome">Nome:</label>
                <input type="text" name="nome" id="nome" class="form-control formPlaceholder" placeholder="Digite o nome da Fragancia">
              </div>
              <div class="col">
